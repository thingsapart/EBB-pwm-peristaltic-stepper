...
<div style="display: inline">https://github.com/stm32duino/Arduino_Core_STM32/wiki/Getting-Started</div> to the "additional Boards Managers" section at the bottom. Wait for the definitions to download
